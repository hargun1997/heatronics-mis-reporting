...
export const MONTHLY_MIS: MonthlyMIS[] = [
  ...
  },
  {
    ...
    "cogmLines": {
      ...
      "Manufacturing Costs (job work, wages, addl. charges)": -662292.03,
      "Inward Freight": -36584,
      "Stock movement (Opening − Closing)": 0,
...
// ----------------------------------------------------------------------------
// Channel ad spend by month (₹) — used to attribute Sales & Marketing to
// channels in the Channel P&L. D2C (Shopify) = Meta + Google spend; Amazon =
// Amazon Ads total cost. The remaining booked S&M is attributed to Blinkit.
// Keyed by month "YYYY-MM"; months absent here contribute zero ad spend.
// ----------------------------------------------------------------------------

/** D2C (Shopify) paid marketing per month = Meta + Google ad spend (₹). */
export const D2C_AD_SPEND: Record<string, number> = {
  '2025-08': 60252,    // Meta 29,459 + Google 30,793
  '2025-09': 279075,   // 138,283 + 140,792
  '2025-10': 780995,   // 370,578 + 410,417
  '2025-11': 1308405,  // 662,642 + 645,763
  '2025-12': 1701059,  // 811,877 + 889,182
  '2026-01': 1651203,  // 799,426 + 851,777
  '2026-02': 1841069,  // 1,236,133 + 604,936
  '2026-03': 1750960,  // 1,303,809 + 447,151
  '2026-04': 1489568,  // 957,885 + 531,683
  '2026-05': 1256629,  // 892,645 + 363,984
  '2026-06': 696975,   // 476,987 + 219,988
  '2026-07': 204760,   // 166,118 + 38,642
};

/** Amazon Ads total cost per month (₹). */
export const AMAZON_AD_SPEND: Record<string, number> = {
  '2024-07': 298158.38,
  '2024-08': 345513.37,
  '2024-09': 556728.71,
  '2024-10': 665842.57,
